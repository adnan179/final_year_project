...
const StudentDetails = () => {
  const { studentRollnumber, projectNumber, adminEmail } = useParams();
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:4000/student/${studentRollnumber}`)
      .then((response) => {
  ...
  }, [projectNumber, studentRollnumber]);
  ...
  return (
    <div className="flex flex-row w-full h-screen bg-gradient-to-r from-[#111111] to-[#2C3E50]">
      ...
      <div className="flex flex-col w-[80%] h-screen py-5 px-5 mt-[100px] ml-[70px] text-white gap-6">
        ...
        <div className="flex flex-col pl-16 gap-10">
